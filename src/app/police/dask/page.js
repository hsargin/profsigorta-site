...
Bina Yapım Yılı: ${form.binaYili}
Kat Sayısı: ${form.katSayisi}
Daire m²: ${form.daireMetre}
Kullanım Tipi: ${form.kullanimTipi}

Hasar Durumu: ${form.hasarDurumu}
Tapu Durumu: ${form.tapuDurumu}
Şirket mi?: ${form.sirketMi}
      ...
      <div style={outerWrapStyle}>
        <div style={leftCardStyle}>
          <div style={titleRowStyle}>
            <h1 style={titleStyle}>DASK Sigortası</h1>
            <span style={badgeStyle}>Hızlı Teklif</span>
          </div>

          <p style={subtitleStyle}>
            Bilgilerinizi girin, DASK sigortası için en uygun teklifi hazırlayalım.
          </p>
          ...
          <div style={gridStyle}>
            ...
            {renderInput("binaYili", "Bina Yapım Yılı", "Örn. 2015")}

            {renderInput("katSayisi", "Kat Sayısı", "Örn. 8")}
            {renderInput("daireMetre", "Daire m²", "Örn. 120")}
            {renderInput("kullanimTipi", "Kullanım Tipi", "Mesken / Kiracı / Ev Sahibi")}

            {renderInput("hasarDurumu", "Hasar Durumu", "Hasarsız / Önceki hasar var")}
            {renderInput("tapuDurumu", "Tapu Durumu", "Kat mülkiyeti / Kat irtifakı")}
            {renderInput("sirketMi", "Şirket mi?", "Evet / Hayır")}
